...
private:
    iterator data;      // first element in vector
    iterator avail;     // first element after last element in vector
    iterator limit;     // capacity

    allocator_type alloc; // memory control

    void create();
    void create(size_t, const T&);
    void create(const_iterator, const_iterator);
    void uncreate();
    void growTwice();         //push_back
...
// Vector and memory distribution
template <class T>
